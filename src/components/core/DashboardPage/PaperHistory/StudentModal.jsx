...
export default function StudentModal({ modalData }) {
  ...
  return (
    <div className="  fixed inset-0 z-[1000] !mt-0 grid place-items-center overflow-auto bg-white bg-opacity-10 backdrop-blur-sm">
      ...
      {more && (
        <div className="md:w-[400px] absolute bg-richblack-700 p-4 m-7 rounded-lg">
          {more}..
          <span
            className=" text-richblue-600 cursor-pointer "
