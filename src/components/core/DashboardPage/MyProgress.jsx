...
export default function MyProgress() {
  ...
  useEffect(() => {
    const getProgress = async () => {
      const result = await getStudentProgress(user?._id,token);
      if (result) {
    ...
    <div>
      <div className="">
        ...
        <p className="font-medium text-richblack-50">
          See your progress and start something new.
        </p>
            ...
            reverseProgress?.map((progress) => (
              <div key={progress._id} >
                ...
                <div className=" ">
                    ...
                    {/* title part  */}
                    <div className=" rounded-t-xl  flex space-y-2  md:space-x-2  space-x-4 items-center md:justify-between md:px-8 px-3 py-4 bg-richblack-600 border border-richblack-300 ">
                      <div>
